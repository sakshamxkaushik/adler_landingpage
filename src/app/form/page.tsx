...
export default function Component() {
  const links = [
    ...
    { name: "IR Material", url: "https://adler.cx/" },
    { name: "3D Creator Competition", url: "https://adler.cx/" },
  ];
        ...
        <CardContent className="p-6 flex flex-col items-center">
          ...
          <div className="w-full space-y-3">
            {links.map((link, index) => (
              <a key={index} href={link.url} className="w-full">
                <Button className="w-full bg-[#1D1D1D] hover:bg-[#FC2D7C] text-white transition-colors duration-300 mb-3">
                  {" "}
